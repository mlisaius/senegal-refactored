...
for seed in seeds: #[2018, 2019]:
    ...
    if SAVE == "yes":
        ...
        plot_classification_map(
            ...
            cmap, 
            class_names, 
            f"/maps/mcl66/senegal/{outfolder}/senegal_tessera_prediction_map_whole_{year}_{CLASSIFICATION}{remapped_labels}_15agg.png"
        )
        # Save the prediction map as a numpy file
        np.save(f"/maps/mcl66/senegal/{outfolder}/senegal_tessera_prediction_map_whole_{year}_{CLASSIFICATION}{remapped_labels}_15agg.npy", pred_map_whole)
        
        # Convert the prediction map to TIFF format
        output_path = f"/maps/mcl66/senegal/{outfolder}/senegal_tessera_prediction_map_whole_{year}_{CLASSIFICATION}{remapped_labels}_15agg.tiff"
