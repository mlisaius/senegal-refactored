...
# input_raster_path = f"/maps/mcl66/senegal/representations/{year}_representation_map_10m_utm28n_128bands.tif"
# input_scale_path = f"/maps/mcl66/senegal/representations/{year}_representation_map_10m_utm28n_scales.tif"
# bbox_shapefile = "/maps/mcl66/senegal/supporting/centralsenegal_jcam_bbox.shp"
# paths = [input_raster_path, input_scale_path]


input_raster_path = f"/maps/mcl66/senegal/alphaearth/efm_{year}.tif"

bbox_shapefile = "/maps/mcl66/senegal/supporting/centralsenegal_jcam_bbox.shp"
paths = [input_raster_path]


for input_raster_path in paths:
