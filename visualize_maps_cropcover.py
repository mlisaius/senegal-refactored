...
# -----------------------------
year = 2018
method = "efm" #"stm" # or "stm" or "raw"
npy_file = f"/maps/mcl66/senegal/cropclassification/senegal_{method}_prediction_map_whole_{year}_maincrop_15agg.npy"
...
if year == 2021:
    ...
    class_colors = [
        "black",      # Masked - black
        "orange",       # Cowpea
        "#3B230B",    # Fallow - dark brown
        "pink",    # Groundnut - light brown / tan
        "green",      # Millet
        "yellow",     # Sorghum
        "#90EE90",    # Tree - light green
        "purple",     # Rice
        "red"       # Other
    ]
else:
