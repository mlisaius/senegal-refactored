...
RUNS = 10 # Number of runs for ensemble methods
...
for seed in seeds: 
    ...
    class_report_filename = f'/maps/mcl66/senegal/classification_reports/senegal_specmat_classification_report_{year}_agg_{CLASSIFICATION}.csv'
