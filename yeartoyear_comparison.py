...
if data == "same":
    year1_pred = np.load(f'/maps/mcl66/senegal/landcoverclassification/senegal_tessera_prediction_map_whole_{year1}_15agg.npy')+ 1
    year2_pred = np.load(f'/maps/mcl66/senegal/landcoverclassification/senegal_raw_prediction_map_whole_{year2}_15agg.npy')
else: 
...
if SAVE == True:
    np.save(f'/maps/mcl66/senegal/landcoverclassification/senegal_{data}_change_map_{year1}_{year2}_mlp.npy', change_map)
    ...
    output_tiff_path = f'/maps/mcl66/senegal/landcoverclassification/senegal_{data}_change_map_{year1}_{year2}_{model}.tiff'
