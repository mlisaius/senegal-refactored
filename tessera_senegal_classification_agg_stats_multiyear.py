...
def process_chunk(h_start, h_end, w_start, w_end, file_path):
    ...
    tile_chunk = (np.load(file_path).transpose(1, 2, 0))[h_start:h_end, w_start:w_end, :]
    h, w, b = tile_chunk.shape
    s2_band_chunk = tile_chunk.reshape(-1, b)
...
class_report_filename = f'/maps/mcl66/senegal/classification_reports/senegal_tessera_classification_report_{mixedyear}_agg_{CLASSIFICATION}.csv'
