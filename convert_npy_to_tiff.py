...
def convert_npy_to_tiff(npy_path, ref_tiff_path, out_dir, downsample_rate=1):
    ...
    H, W  = data.shape
    C = 1 if data.ndim == 2 else data.shape[2]  # Number of bands, 1 for single band data
...
if __name__ == "__main__":
    npy_path = f"/maps/mcl66/senegal/representations/{year}_representation_map_10m_utm28n_scales.npy"
    ref_tiff_path = f"/maps/mcl66/senegal/representations/{year}_representation_map_10m_utm28n_128bands.tiff"
    out_dir = "/maps/mcl66/senegal/representations"  # Change to the actual output directory
